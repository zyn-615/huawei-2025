...
const double JUMP_VISCOSITY = 1.6;
const int READ_ROUND_TIME = 37; //一轮读取的时间
const int PRE_DISTRIBUTION_TIME = 25;
const int TEST_DENSITY_LEN = 776;
const int READ_CNT_STATES = 8; //读入的状态，根据上一次连续read的个数确定
int DISK_MIN_PASS = 11;
const int NUM_PIECE_QUEUE = 24;
const double TAG_DENSITY_DIVIDE = 4;
const double UNIT_REQUEST_DIVIDE = 4;
